...
AWSGlueDataCatalog_node1745299768471 = glueContext.create_dynamic_frame.from_catalog(database="stedi_db", table_name="accelerometer_landing", transformation_ctx="AWSGlueDataCatalog_node1745299768471")
...
'''
SQLQuery_node1745300607534 = sparkSqlQuery(glueContext, query = SqlQuery582, mapping = {"myDataSource":Join_node1745299854842}, transformation_ctx = "SQLQuery_node1745300607534")
...
AmazonS3_node1745300076508 = glueContext.getSink(path="s3://stedi-human-sr/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1745300076508")
AmazonS3_node1745300076508.setCatalogInfo(catalogDatabase="stedi_db",catalogTableName="accelerometer_trusted")
